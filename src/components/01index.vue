        ...
        <div class="section">
            <div class="wrapper">
                <div class="wrap-box">
                                ...
                                <li v-for="(item, index) in catelist" :key="item.id">
                                    ...
                                    <div class="item-box">
                                        <dl>
                                            ...
                                            <dd>
                                                <a href="/goods/43.html" v-for="(itemSon, indexSon) in item.subcates" :key="itemSon.id">{{itemSon.title}}</a>
                                            </dd>
                                        </dl>
                                    </div>
                                </li>
                    ...
                    <div class="left-705">
                         <el-carousel>
                        <el-carousel-item v-for="(item, index) in sliderlist" :key="item.id" class="el-carousel__item">
