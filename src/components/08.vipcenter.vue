                            ...
                            <div class="bg-wrap">
                                <div class="avatar-box">
                                    <a href="/user/center/avatar.html" class="img-box">
                                        <img src="../assets/img/bfc737fbf3745022e4bea20e481d1b2b.gif" alt="">
                                    </a>
                                    <h3>
                        ...
                        <div class="right-auto">
                            <div class="bg-wrap" style="min-height: 765px;">
                                ...
                                <div class="center-head clearfix">
                                    ...
                                    <div class="list-box">
                                        <h3>欢迎您~ {{orderinfo.accept_name}}</h3>
                                        <ul>
                                            <li>组别：注册会员</li>
                                            <li>手机：{{orderinfo.mobile}}</li>
  ...
  created() {
    this.$axios
      ...
      .then(repsonse => {
        ...
        this.orderinfo = repsonse.data.message.orderinfo;
      });
  }
};
</script>
