                                        ...
                                        <div class="form-box accept-box form-box1">
                                            <dl class="head form-group">
                                                <dd>
                                                    ...
                                                    <!-- <a href="#/site/goods/payment/12" ></a> -->
                                                    <router-link v-if="orderInfo.statusName == '待付款' " class="btn-pay" :to="`/payorder/`+ $route.params.id" >去付款</router-link>
                                                    <!---->
                                                </dd>
                                            </dl>
                                            <dl class="form-group">
                                            ...
                                            <dl class="form-group">
                                                <dt>支付方式：</dt>
                                                <dd>支付宝_{{orderInfo.paymentTitle}}</dd>
                                            </dl>
                                        </div>
